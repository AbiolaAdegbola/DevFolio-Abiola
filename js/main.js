...
const TRANSLATIONS = {
  fr: {
    ...
    'hero.description': 'Ingénieur Full Stack &amp; Automaticien Industriel passionné, basé en <strong>Côte d\'Ivoire</strong>. Je conçois des solutions web, mobiles et des systèmes industriels intelligents.',
    'hero.cta1': 'Voir mes projets',
    'hero.cta2': 'Télécharger CV',
    'hero.scroll': 'Défiler',
    'stats.projects': 'Projets réalisés',
    'stats.techs': 'Technologies maîtrisées',
    ...
    'services.sub': 'Des solutions sur mesure pour vos besoins digitaux et industriels',
    'service.web.title': 'Développement Web',
    'service.web.desc': 'Sites vitrine, applications web et plateformes digitales modernes, responsives et performants.',
    'service.mobile.title': 'Applications Mobiles',
    'service.mobile.desc': 'Applications cross-platform hautes performances pour iOS et Android avec une expérience native.',
    'service.auto.title': 'Automatisme Industriel',
    'service.auto.desc': 'Conception et programmation de systèmes automatisés avec Siemens SIMATIC S7-300 et TIA PORTAL.',
    'service.uiux.title': 'UI/UX & SEO',
    'service.uiux.desc': 'Optimisation de l\'expérience utilisateur et du référencement naturel pour maximiser votre visibilité.',
    'exp.tag': '// Parcours',
    'exp.title': 'Mon <span class="gradient-text">expérience</span>',
    'exp.tab.pro': 'Professionnel',
    'exp.tab.asso': 'Associatif',
    'exp.tab.formation': 'Formation',
    'skills.tag': '// Compétences',
    'skills.title': 'Ma <span class="gradient-text">stack technique</span>',
    'skills.sub': 'Technologies et outils que je maîtrise au quotidien',
    'portfolio.tag': '// Portfolio',
    'portfolio.title': 'Mes <span class="gradient-text">projets</span>',
    'portfolio.sub': 'Quelques réalisations dont je suis particulièrement fier',
    'portfolio.filter.all': 'Tous',
    'portfolio.filter.web': 'Web',
    'portfolio.filter.mobile': 'Mobile',
    'portfolio.filter.industrial': 'Industriel',
    'portfolio.filter.automation': 'Automatisation',
    'pricing.tag': '// Tarifs',
    'pricing.title': 'Mes <span class="gradient-text">offres</span>',
    'pricing.sub': 'Des tarifs transparents pour des projets de qualité professionnelle',
    'pricing.cta': 'Demander un devis',
    'pricing.btn3': 'Discutons de votre projet',
    'testimonials.tag': '// Témoignages',
    'testimonials.title': 'Ce qu\'ils <span class="gradient-text">disent</span>',
    'testimonials.sub': 'Retours de clients et partenaires sur nos collaborations',
    'cta.title': 'Prêt à donner vie à votre projet ?',
    'cta.desc': 'Discutons de vos idées et transformons-les en réalité digitale.',
    'cta.btn': 'Démarrer un projet',
    'contact.tag': '// Contact',
    'contact.title': 'Travaillons <span class="gradient-text">ensemble</span>',
    'contact.sub': 'N\'hésitez pas à me contacter pour discuter de votre projet',
    ...
    'footer.services.auto': 'Automatisme Industriel',
    'footer.contact.title': 'Coordonnées',
    'footer.cv': 'Télécharger CV',
    'footer.rights': '© 2025 Abiola Adegbola. Tous droits réservés.',
    'footer.made': 'Conçu avec <i class="fas fa-heart"></i> en Côte d\'Ivoire',
    'nav.expertise': 'Expertise',
    'expertise.tag': '// Expertise',
    'expertise.title': 'Compétences <span class="gradient-text">métier</span>',
    'expertise.sub': 'Rôles, responsabilités et domaines d\'intervention professionnels',
    'expertise.mgmt.title': 'Management &amp; Gouvernance IT',
    'expertise.cloud.title': 'Cloud &amp; Plateformes',
    'expertise.ops.title': 'Opérations &amp; Support IT',
    'expertise.dev.title': 'Développement &amp; Intégration IT',
    'devis.title': 'Demande de devis',
    'devis.subtitle': 'Je vous réponds sous 24h',
    'devis.name': 'Nom et prénom',
    'devis.name.ph': 'Ex : Kouassi Jean-Marc',
    'devis.phone': 'Téléphone',
    'devis.email': 'Adresse e-mail',
    'devis.type': 'Type de projet',
    'devis.sector': 'Secteur d\'activité',
    'devis.budget': 'Budget estimé',
    'devis.urgency': 'Délai souhaité',
    'devis.details': 'Description du projet',
    'devis.optional': '(optionnel)',
    'devis.details.ph': 'Décrivez brièvement votre projet, vos attentes, vos contraintes…',
    'devis.privacy': 'Vos données sont confidentielles et ne seront pas partagées.',
    'devis.submit': 'Envoyer la demande',
  },
  en: {
    'nav.home': 'Home',
    'nav.about': 'About',
    ...
    'hero.description': 'Passionate Full Stack Engineer &amp; Industrial Automation Engineer based in <strong>Côte d\'Ivoire</strong>. I design web, mobile solutions and intelligent industrial systems.',
    ...
    'services.sub': 'Tailor-made solutions for your digital and industrial needs',
    'service.web.title': 'Web Development',
    'service.web.desc': 'Showcase websites, web applications and modern, responsive, high-performance digital platforms.',
    'service.mobile.title': 'Mobile Applications',
    'service.mobile.desc': 'High-performance cross-platform applications for iOS and Android with a native experience.',
    'service.auto.title': 'Industrial Automation',
    'service.auto.desc': 'Design and programming of automated systems with Siemens SIMATIC S7-300 and TIA PORTAL.',
    'service.uiux.title': 'UI/UX & SEO',
    'service.uiux.desc': 'User experience optimization and natural search engine referencing to maximize your online visibility.',
    'exp.tag': '// Background',
    'exp.title': 'My <span class="gradient-text">experience</span>',
    'exp.tab.pro': 'Professional',
    'exp.tab.asso': 'Community',
    'exp.tab.formation': 'Education',
    'skills.tag': '// Skills',
    'skills.title': 'My <span class="gradient-text">tech stack</span>',
    'skills.sub': 'Technologies and tools I master on a daily basis',
    'portfolio.tag': '// Portfolio',
    'portfolio.title': 'My <span class="gradient-text">projects</span>',
    'portfolio.sub': 'A few achievements I am particularly proud of',
    ...
    'pricing.tag': '// Pricing',
    'pricing.title': 'My <span class="gradient-text">packages</span>',
    'pricing.sub': 'Transparent pricing for projects of professional quality',
    'pricing.cta': 'Request a quote',
    'pricing.btn3': 'Let\'s discuss your project',
    'testimonials.tag': '// Testimonials',
    'testimonials.title': 'What they <span class="gradient-text">say</span>',
    'testimonials.sub': 'Feedback from clients and partners about our collaborations',
    'cta.title': 'Ready to bring your project to life?',
    'cta.desc': 'Let\'s discuss your ideas and turn them into digital reality.',
    'cta.btn': 'Start a project',
    'contact.tag': '// Contact',
    'contact.title': 'Let\'s work <span class="gradient-text">together</span>',
    'contact.sub': 'Feel free to contact me to discuss your project',
    'contact.phone': 'Phone',
    ...
    'footer.tagline': 'Full Stack Developer & Industrial Automation Engineer based in Côte d\'Ivoire.',
    'footer.nav.title': 'Navigation',
    ...
    'footer.services.auto': 'Industrial Automation',
    'footer.contact.title': 'Contact Info',
    'footer.cv': 'Download CV',
    'footer.rights': '© 2025 Abiola Adegbola. All rights reserved.',
    'footer.made': 'Made with <i class="fas fa-heart"></i> in Côte d\'Ivoire',
    'nav.expertise': 'Expertise',
    'expertise.tag': '// Expertise',
    'expertise.title': 'Professional <span class="gradient-text">expertise</span>',
    'expertise.sub': 'Roles, responsibilities and areas of professional practice',
    'expertise.mgmt.title': 'Management &amp; IT Governance',
    'expertise.cloud.title': 'Cloud &amp; Platforms',
    'expertise.ops.title': 'IT Operations &amp; Support',
    'expertise.dev.title': 'Development &amp; IT Integration',
    'devis.title': 'Request a quote',
    'devis.subtitle': 'I will reply within 24 hours',
    'devis.name': 'Full name',
    'devis.name.ph': 'Ex: John Smith',
    'devis.phone': 'Phone',
    'devis.email': 'Email address',
    'devis.type': 'Project type',
    'devis.sector': 'Industry',
    'devis.budget': 'Estimated budget',
    'devis.urgency': 'Desired timeline',
    'devis.details': 'Project description',
    'devis.optional': '(optional)',
    'devis.details.ph': 'Briefly describe your project, expectations, constraints…',
    'devis.privacy': 'Your data is confidential and will not be shared.',
    'devis.submit': 'Send request',
  }
};

(function initLangSwitcher() {
  const KEY = 'devfolio-lang';
